...
import { FormChecksFeature } from '../../../store/formchecks/formchecks.reducer';
import {
  deleteFormCheck,
  getAllFormChecks,
} from '../../../store/formchecks/formchecks.action';
import { ProductConfigurationFeature } from '../../../store/product-configurations/product-configuration.reducer';
import {
  createProductConfiguration,
  getProductConfiguration,
  updateProductConfiguration,
} from '../../../store/product-configurations/product-configurations.actions';
